  ...
  return (
    <section className="mt-10 flex flex-col gap-7 ">
      <div className="relative h-12 flex items-center bg-slate-200">
        ...
        <div
          className={`w-4/12 absolute right-0 -translate-y-6 border-2 border-green-400
                      flex justify-center`}
        >
          <Image
            src="/drink2.png"
            ...
            className={`scale-75 
                        xxs:scale-70 
                        xs:scale-60 xs:max-w-52`}
          />
        </div>
      </div>
      {store.selectedItems.filter((item) => item.category === "drink").length !== 0 ? (
        <ul
          className={`mx-auto my-0 w-full ${space_list_topBottom} flex flex-col align-middle gap-3
                        sm:w-4/5`}
        >
          {store.selectedItems
      ...
      <div className={`mt-12`}>
        ...
        >
          ...
          <div
            className={`w-4/12 absolute -translate-y-4 right-0 
